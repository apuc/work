...
$this->title = "Работа Донецк 2025";
$this->registerMetaTag(['name'=>'description', 'content' => "Найти работу в Донецке, в 2025 году - просто! Поиск работы в Донецке, в 2025 году. Более 2000 открытых вакансий! Свежие Вакансии каждый день. Заходи!"]);
$this->registerMetaTag(['name'=>'og:title', 'content' => "Работа Донецк 2025"]);
...
$this->registerMetaTag(['name'=>'og:description', 'content' => "Найти работу в Донецке, в 2025 году - просто! Поиск работы в Донецке, в 2025 году. Более 2000 открытых вакансий! Свежие Вакансии каждый день. Заходи!"]);
        ...
        <div class="container">
            <div class="v-content-top">
                <div class="home__aside-header">
                    <h1 class="resume__title">Работа Донецк 2025</h1>
                    <div class="search">
