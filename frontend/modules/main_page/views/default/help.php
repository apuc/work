<section class="help">
    ...
    <div class="container">
        ...
        <div class="single-block single-block-slider">
            <div class="single-block__left news-items">
                <div class="news-item">
                    <h2>Размещение вакансии <img src="/images/new_item.png" alt=""></h2>
                    <div>
                        <p class="red-line">
                            Для размещения вакансии зарегистрируйтесь на сайте
                            <a href="/" target="_blank">rabota.today</a>
                        </p>
                        <p>
                            Что бы зарегистрироваться нажмите Вход», затем «Зарегистрироваться»,
                            заполните форму регистрации. При регистрации указывайте действующий Email, регистрацию
                            необходимо подтвердить перейдя по ссылке из письма, которое будет выслано на указанный
