...
<section class="all-block all-resume"><img class="all-block__dots2" src="/images/bg-dots.png" alt="" role="presentation"/>
...
<!--                                    </p>-->
                                </div><span class="single-card-resume__price"><?=$resume->min_salary?>-<?=$resume->max_salary?> RUB</span>
                                <p class="single-card-resume__name"><?=$resume->employer->second_name?> <?=$resume->employer->first_name?> · возраст - <?= $resume->employer->age ?> · <?=$resume->city?>
                                </p>
                                ...
                                <p class="single-card-resume__name-work"><?=$resume->lastExperience->post?>, <?=$resume->lastExperience->name?>
                                </p>
                                <p class="single-card-resume__date-work"><?=Experience::$months[$resume->lastExperience->month_from]?> <?=$resume->lastExperience->year_from?> — <?=Experience::$months[$resume->lastExperience->month_to]?> <?=$resume->lastExperience->year_to?>
                                </p>
                                <p class="single-card-resume__last-check">Обновлено <?=date('d.m.Y', $resume->update_time)?>
                                </p>
                            </div>
                        </div>
                        <div class="single-card-resume__bottom">
                            ...
                            <div class="single-card-resume__soc">
                                ...
                                <div class="single-card-resume__soc-block">
                                    <?php if($resume->vk):?>
                                    <a class="vk-bg" href="<?=$resume->vk?>"><img src="/images/vk.svg" alt="" role="presentation"/></a>
                                    <?php endif ?>
                                    <?php if($resume->facebook):?>
                                    <a class="fb-bg" href="<?=$resume->facebook?>"><img src="/images/fb.svg" alt="" role="presentation"/></a>
                                    <?php endif ?>
                                    <?php if($resume->instagram):?>
                                    <a class="inst-bg" href="<?=$resume->instagram?>"><img src="/images/instagram.svg" alt="" role="presentation"/></a>
                                    <?php endif ?>
                                </div>
                            </div>
                            <?php endif ?>
