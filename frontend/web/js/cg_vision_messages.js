...
var visiPrivateMessages = (function() {
    ...
    function getUrl() {
        ...
        // var url = protocol + '//' + host + '/' + '/msg/api/p-m';
        return url;
    };
    ...
    return function(id_block_) {
        ...
        var init = function() {
            ...
            self.subjectType = self.form.find('[name="subject_type"]');
            self.subjectId = self.form.find('[name="subject_id"]');
        ...
        var updateMessage = function(action) {
            ...
            var subject_id = self.subjectId.val();
            var subject_type= self.subjectType.val();
            if(!from_id) {
                return null;
            }
            $.ajax({
                ...
                // url: self.base_url,
                url: "/msg/api/p-m",
                data: {from_id:from_id, action:action, subject_type:subject_type, subject_id:subject_id},
        ...
        var sendMessage = function(whom_id, text) {
            $.ajax({
                ...
                data: {
                    ...
                    action:'sendMessage',
                    subject_id: self.subjectId.val(),
                    subject_type: self.subjectType.val()
                },
                success: function(msg){
                    if(msg.status) {
                        self.updateBox(msg.data);
        ...
        this.updateBox = function(data) {
            ...
            var subject_type = data.subject_type;
            var html = '';
        ...
        this.form.submit(function() {
            ...
            sendMessage(id, text,subject_id, subject_type);
            return false;
        });
