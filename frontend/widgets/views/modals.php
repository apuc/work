...
<div class="modal-block jsModal">
    ...
    <div class="modal-position">
        ...
        <div class="modal-style modal-reg jsModalReg">
            ...
            <?= $form->field($registration_form, 'reCaptcha')->widget(\himiklab\yii2\recaptcha\ReCaptcha::className(), ['siteKey' => '6LdiO3sbAAAAAAUO9ZUAlgxw0qBq1AYDrLSN-M42'])->label(false) ?>
