...
<table style="
	...
	">
		<td>
			...
			text-align: justify;
			">
				В скором времении она появилась в списке заявок новой биржи труда и доступна пользователям сайта.
			</p>
			<p style="
			margin-top: 0;
			margin-bottom: 35px;
			...
			text-align: justify;
			">
				Ознакомиться со статистикой просмотров и откликами можно <strong>в бесплатном режиме.</strong> Для этого достаточно зайти в
				соответствующие разделы личного кабинета, используя логин и пароль, которые были указаны во время регистрации на сайте.
			</p>
		</td>
	</tr>
	<tr style="
	...
	">
		<td style="display: block; margin: 0 auto;">
			<a href="https://rabota.today/vacancy/view/<?=$variable?>" style="
				display: block;
				width: 400px;
				margin: 0 auto;
				padding: 8px 14px;
