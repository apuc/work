...
class MinifyController extends Controller
{
    public function actionIndex() {
        ...
        $this->minifyCSS(Yii::getAlias("@frontend/web/css/back_styles.css"), Yii::getAlias("@frontend/web/css/back_styles.min.css"));
        $this->minifyCSS(Yii::getAlias("@frontend/web/css/style.css"), Yii::getAlias("@frontend/web/css/style.min.css"));
        $this->minifyCSS(Yii::getAlias("@frontend/web/js/slick.css"), Yii::getAlias("@frontend/web/js/slick.min.css"));
    }
